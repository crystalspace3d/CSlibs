...
# Base libs
scripts/url-get libpng ftp://ftp.simplesystems.org/pub/libpng/png/src/libpng-1.5.2.tar.xz \
  libpng-1.5.2 xz
...
scripts/url-get libfreetype http://download.savannah.gnu.org/releases/freetype/freetype-2.4.4.tar.bz2 \
  freetype-2.4.4 bz2
scripts/url-get libbullet http://bullet.googlecode.com/files/bullet-2.78-r2387.tgz \
  bullet-2.78 gz
scripts/url-get libpcre ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/pcre-8.12.tar.bz2 \
  pcre-8.12 bz2
