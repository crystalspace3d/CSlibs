...
scripts/svn-get libode https://opende.svn.sourceforge.net/svnroot/opende/branches/0.8/
...
scripts/url-get libvorbis http://downloads.xiph.org/releases/vorbis/libvorbis-1.1.2.tar.gz \
  libvorbis-1.1.2 gz
scripts/url-get libfreetype http://mesh.dl.sourceforge.net/sourceforge/freetype/freetype-2.3.2.tar.bz2 \
  freetype-2.3.2 bz2
