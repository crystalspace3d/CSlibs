...
# Base libs
scripts/url-get libpng ftp://ftp.simplesystems.org/pub/libpng/png/src/libpng-1.5.6.tar.xz \
  libpng-1.5.6 xz
...
scripts/url-get libfreetype http://download.savannah.gnu.org/releases/freetype/freetype-2.4.7.tar.bz2 \
  freetype-2.4.7 bz2
scripts/url-get libbullet http://bullet.googlecode.com/files/bullet-2.79-rev2440.tgz \
  bullet-2.79 gz
